...
public class CanvasPanel extends JPanel{
    ...
    public void draw(double fps, int cycles){
        ...
        drawer.draw(world.getParticleList(), world.getFieldPointList(), dImgG2D, sImgG2D);
        drawSelected();
        drawMassCenter();
        drawGUI(fps);
    ...
    public void setDrawer(Drawer entityDrawer){ this.drawer = entityDrawer; }
}
