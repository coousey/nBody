...
import nbody.pkg6.accelerationCalculators.BrutForceAccCalc;
import nbody.pkg6.accelerationCalculators.QTreeAccCalc;
import nbody.pkg6.drawers.ColorFieldDrawer;
import nbody.pkg6.drawers.MixFieldDrawer;
import nbody.pkg6.drawers.StandardEntityDrawer;
import nbody.pkg6.drawers.VectorEntityDrawer;
import nbody.pkg6.drawers.VectorFieldDrawer;
        ...
        while( !eventStack.empty()){
            ...
            if(e.getClass() == ActionEvent.class){   
                ...
                // save
                    ...
                    world.saveParticlesToFile();
                // load
                else if(ae.getSource() == window.getLoadButton())
                    world.loadParticlesFromFile();
                // field radio buttons
                else if(ae.getSource() == window.getNonWithVectorsRadioButton()){
                    window.getCanvasPanel().setParticleDrawer(new VectorEntityDrawer());
                    ...
                    window.getCanvasPanel().setParticleDrawer(new StandardEntityDrawer());
                    window.getCanvasPanel().setFieldDrawer(null);
                    world.setBackgroundColor(Color.WHITE);
                    world.setFieldAccCalc(null);
                }
                    ...
                    world.setBackgroundColor(Color.WHITE);
                    if(window.getBrutRadioButton().isSelected())
                        world.setFieldAccCalc(new BrutForceAccCalc());
                    else 
                ...
                // calc radio butons
                else if(ae.getSource() == window.getBrutRadioButton()){
                    world.setParticleAccCalc(new BrutForceAccCalc());
                    world.setFieldAccCalc(new BrutForceAccCalc());
                }
