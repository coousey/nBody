...
public class Window extends JFrame{
    ...
    private final JLabel brutLabel = new JLabel("b");
    private final JRadioButton brutRadioButton = new JRadioButton();
    ...
    public Window(World world){
        ...
        // calc radio buttons
        brutRadioButton.addActionListener(listeners.getActionListener());
        buttonPanel.add(brutLabel);
        buttonPanel.add(brutRadioButton);
        ...
        calcButtonGroup.add(brutRadioButton);
    ...
    public JRadioButton getBrutRadioButton(){ return brutRadioButton; }
